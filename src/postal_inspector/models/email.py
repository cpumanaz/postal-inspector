...
class ParsedEmail:
    ...
    Attributes:
        ...
        return_path: The Return-Path (envelope sender) header, if present.
        auth_results: The Authentication-Results header(s) — SPF/DKIM/DMARC verdicts
            added by the upstream mail server. A spoofed From typically fails these.
    """
